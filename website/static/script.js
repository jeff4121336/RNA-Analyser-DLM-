const modelDescriptions = [
	{
		...
		"description": "This model predicts the class of an input RNA sequence. The possible RNA types \
	...
	{
		"id": "m3",
		"title": "14-Class Multi Label Model",
		"description": "This model predicts multiple classes for input RNA sequences. The possible RNA types \
		are 5S rRNA, 5.8S rRNA, tRNA, ribozyme, CD-box, miRNA, Intron gpI, Intron gpII, scaRNA, HACA-box, \
		riboswitch, IRES, leader, and mRNA, totaling 14 classes. The prediction includes the multi-label \
		results along with their corresponding prediction scores."
	}
]
...
function handleModelClick(event) {
	...
	const selectedModel = modelDescriptions.find(model => model.id === clickedModelId);
...
document.getElementById('prompt-send').addEventListener('click', function(event) {
